...
st.write('''Esse Streamlit é a parte de demonstração dos dados 
         do projeto de previsão de renda proposto pelo curso de ciência de dados da EBAC.
         O foco aqui será mostrar as variáveis mais correlativas, e tirar insights sobre elas
         de uma maneira que fique apresentável.''')
